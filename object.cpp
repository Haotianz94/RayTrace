...
void Scene::initScene3()
{
	...
	proper->setTexture( new Texture( "textures2/wood.jpg" ));
	...
	proper1->setTexture( new Texture( "textures2/marble.jpg" ));
	...
	proper2->setTexture( new Texture( "textures2/marble.jpg" ));
	...
	proper4->setTexture( new Texture( "textures2/marble.jpg" ));
	...
	proper6->setTexture( new Texture( "textures2/marble.jpg" ));
